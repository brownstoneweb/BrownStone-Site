    ...
    <section className="relative h-screen min-h-[720px] flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-[2] w-full max-w-[900px] px-6">
        ...
        <div className="anim-fadeup-1 inline-flex items-center gap-3 mb-7 px-5 py-2.5 border border-gold/40" style={{ background: 'rgba(201,168,76,0.12)' }}>
          ...
          <span className="text-[0.6rem] tracking-[0.32em] uppercase text-white font-medium">Phase 1 Now Open — Akosombo, Volta Region</span>
        </div>
        ...
        {/* Subtext */}
        <p className="anim-fadeup-3 font-serif-luxury text-white leading-[1.7] mb-10 mx-auto max-w-[560px]" style={{ fontSize: 'clamp(1rem, 2vw, 1.3rem)', fontWeight: 300 }}>
        ...
        <div className="anim-fadeup-4 flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            className="bg-gold text-white px-10 py-4 text-[0.72rem] tracking-[0.2em] uppercase font-bold hover:bg-gold-light transition-all duration-300 inline-flex items-center gap-2 whitespace-nowrap"
      ...
      <div className="anim-fadeup-5 absolute bottom-8 left-1/2 -translate-x-1/2 z-[2] flex flex-col items-center gap-2">
        <span className="text-[0.55rem] tracking-[0.3em] text-white uppercase">Discover Celestia</span>
