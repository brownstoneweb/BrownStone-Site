    ...
    <section id="brochure" className="py-24 lg:py-32 px-6" style={{ background: '#1C1916' }}>
      <div className="max-w-[560px] mx-auto text-center">
        <div className="reveal-on-scroll">
          <span className="eyebrow-text block mb-3">Get the Full Prospectus</span>
        ...
        <div className="mt-10 reveal-on-scroll reveal-delay-2">
          {submitted ? (
            ...
            >
              ...
              />
              <p className="text-[0.62rem] text-luxury-mist/50 text-right mb-3">{charCount}/500</p>
              <button
                type="submit"
                className="w-full bg-gold text-luxury-dark py-4 text-[0.75rem] tracking-[0.22em] uppercase font-bold hover:bg-gold-light transition-all duration-300 cursor-pointer whitespace-nowrap"
              >
                Send Me the Brochure — No Cost
              </button>
              <p className="text-[0.65rem] text-luxury-mist/40 mt-3">
