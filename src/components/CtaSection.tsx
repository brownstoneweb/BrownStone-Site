    ...
    <section id="enquire" className="relative min-h-[85vh] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-[2] w-full max-w-[720px] px-6 py-20">
        <div className="reveal-on-scroll">
          <span className="eyebrow-text block mb-4">Reserve Your Residence</span>
          <h2 className="font-serif-luxury text-white leading-tight mb-4" style={{ fontSize: 'clamp(2.8rem, 7vw, 5.5rem)', fontWeight: 300 }}>
            Your Piece of<br /><em className="italic text-gold">Peace</em> Awaits.
          </h2>
          <p className="text-luxury-mist text-sm leading-relaxed mb-12 max-w-lg mx-auto">
        ...
        <div className="reveal-on-scroll reveal-delay-2 flex flex-col lg:flex-row items-center justify-center gap-4 mb-6">
          <div className="backdrop-blur-sm border border-gold/40 px-10 py-7 text-center hover:border-gold transition-all duration-300" style={{ background: 'rgba(8,8,8,0.7)' }}>
            <span className="text-[0.58rem] tracking-[0.25em] uppercase text-luxury-mist block mb-2">Call or WhatsApp Direct</span>
            <a href="tel:+233244028485" className="font-serif-luxury text-gold block hover:text-gold-light transition-colors duration-300" style={{ fontSize: '2.2rem', fontWeight: 300 }}>
              024 402 8485
            </a>
            <span className="text-[0.6rem] text-luxury-mist mt-1 block">Mon–Sat, 8am–6pm · Direct Property Line</span>
          </div>
        ...
        <p className="text-sm text-luxury-mist relative z-[2]">
          Email:{' '}
          <a href="mailto:ghanaisthefuture@brownstoneltd.com" className="text-gold hover:text-gold-light transition-colors duration-300">
